...
function BookingForm(props) {
    ...
    return (
        <div className="bookingFormContainer">
            <form style={{display: 'grid', minWidth: '400px', maxWidth: '400px', gap: '20px'}} onSubmit={handleSubmit}>
            {/*<form onSubmit={handleSubmit}>*/}
                ...
                <button type="submit" aria-label="Make Your reservation" disabled={!isFormValid}>Make Your reservation
                </button>
            </form>
        </div>
    );
